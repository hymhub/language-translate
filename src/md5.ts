// utils/md5.js
function safeAdd(x6: number, y5: number) {
...
function md5cmn(q7: number, a4: any, b6: any, x6: any, s6: any, t5: any) {
  return safeAdd(bitRotateLeft(safeAdd(safeAdd(a4, q7), safeAdd(x6, t5)), s6), b6);
}
function md5ff(a4: number, b6: number, c5: number, d5: number, x6: any, s6: number, t5: number) {
  return md5cmn(b6 & c5 | ~b6 & d5, a4, b6, x6, s6, t5);
}
function md5gg(a4: number, b6: number, c5: number, d5: number, x6: any, s6: number, t5: number) {
  return md5cmn(b6 & d5 | c5 & ~d5, a4, b6, x6, s6, t5);
}
function md5hh(a4: number, b6: number, c5: number, d5: number, x6: any, s6: number, t5: number) {
  return md5cmn(b6 ^ c5 ^ d5, a4, b6, x6, s6, t5);
}
function md5ii(a4: number, b6: number, c5: number, d5: number, x6: any, s6: number, t5: number) {
  return md5cmn(c5 ^ (b6 | ~d5), a4, b6, x6, s6, t5);
}
function binlMD5(x6: any, len: number) {
...
function rawMD5(s6: any) {
  return rstrMD5(str2rstrUTF8(s6));
}
function hexMD5(s6: any) {
  return rstr2hex(rawMD5(s6));
}
function rawHMACMD5(k5: any, d5: any) {
  return rstrHMACMD5(str2rstrUTF8(k5), str2rstrUTF8(d5));
}
function hexHMACMD5(k5: any, d5: any) {
  return rstr2hex(rawHMACMD5(k5, d5));
}
export function md5(string: any, key?: any, raw?: any) {
